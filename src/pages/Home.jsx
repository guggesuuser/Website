...
import MoensterliTabelllen from "../components/MoensterliTabelllen";
  ...
  "
      ...
      <section id="moensterli" className="py-16 bg-hui text-qui">
        <div className="w-full max-w-6xl mx-auto px-4">
          {" "}
          {/* max-width erhöht für die Tabelle */}
          ...
          <strong>
            Für 2027 sind wir bereits komplett ausgebucht – für 2028 haben wir
            aber noch freie Plätze!
          </strong>
          <br />
          <br />
          <p className="text-base sm:text-xl text-pri flex items-center gap-2 font-bold">
